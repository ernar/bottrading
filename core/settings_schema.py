...
SETTINGS_SCHEMA: list[dict] = [
    ...
    {"key": "DEEPSEEK_THINKING", "label": "Pensamiento DeepSeek (thinking)", "group": "Asistente", "type": "str", "secret": False, "hot": True,
     "help": "Modo razonado de los modelos DeepSeek V4 (deepseek-v4-flash/pro): 'enabled' (el modelo razona antes de responder; ON por defecto) o 'disabled'. Más fiable para señales pero más lento/caro. No afecta a deepseek-chat (nunca piensa) ni a deepseek-reasoner (siempre piensa)."},
    {"key": "DEEPSEEK_REASONING_EFFORT", "label": "Esfuerzo de razonamiento DeepSeek", "group": "Asistente", "type": "str", "secret": False, "hot": True,
     "help": "Profundidad del pensamiento en V4 cuando está activo: 'high' o 'max'. Vacío = el del modelo. Más esfuerzo = más calidad pero más latencia y coste."},
