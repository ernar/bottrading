...
AGENT_BLUEPRINTS: dict[str, AgentBlueprint] = {
    "btc-agent": AgentBlueprint(
        ...
        params=AgentParams(
            ...
            # Rotación rápida: asegura a breakeven PRONTO (0.9×ATR a favor) para no
            # devolver ganancias en un giro, y sigue; toma parcial a mitad de camino
            # al TP. Cripto volátil: el paso del trailing queda algo más holgado.
            use_trailing_stop=True,
            trailing_breakeven_atr_mult=0.9,
    ...
    "eurusd-agent": AgentBlueprint(
        ...
        params=AgentParams(
            ...
            use_trailing_stop=True,
            trailing_breakeven_atr_mult=0.7,
